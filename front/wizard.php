...
if ($_SESSION['glpiactiveprofile']['interface'] == 'central') {
   Html::header(PluginVideoprojecteursWizard::getTypeName(2), '', "assets", "pluginvideoprojecteursmenu");
} else {
   Html::helpHeader(PluginVideoprojecteursWizard::getTypeName(2));
}

$wizard = new PluginVideoprojecteursWizard();
$wizard->showMenu();
